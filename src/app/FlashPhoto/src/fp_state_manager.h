...
#ifndef SRC_APP_FLASHPHOTO_SRC_FP_STATE_MANAGER_H_
#define SRC_APP_FLASHPHOTO_SRC_FP_STATE_MANAGER_H_
...
#endif  /* SRC_APP_FLASHPHOTO_SRC_FP_STATE_MANAGER_H_ */
